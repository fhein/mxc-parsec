...
class BoolParser extends ParserDelegator
{
    ...
    // uses a SymbolsParser which is a PreSkipper
    // so it's ok to be a PrimitiveParser without preskipping
    ...
    public function setPolicy(BoolPolicy $policy = null)
    {
        ...
        $this->delegate = new SymbolsParser($this->domain, $policy->symbols);
    }
}
